...
public class SimpleApiTest {
    public static void main(String[] args) {
        try {
            ...
            // Test detailed lunar information
            System.out.println("Testing detailed lunar info...");
            String lunarInfo = MoonPhases.getLunarInfo();
            ...
            // No cleanup needed for Swiss Ephemeris calculations
            System.out.println("Swiss Ephemeris test completed.");
        }
    }
}
